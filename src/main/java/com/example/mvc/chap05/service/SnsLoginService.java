...
public class SnsLoginService {
    ...
    public void kakaoService(Map<String,String> requestMap, HttpSession session){
        ...
        memberService.join(
                SignUpRequestDTO.builder().account(kakaoAccount.getEmail()).email(kakaoAccount.getEmail()).name(kakaoAccount.getProfile().getNickname()).password("9999").build(),
    ...
    private String getkakaoAccessToken(Map<String,String> requestMap) {
        ...
        // params1 : 요청 url
        // params2 : 요청 메서드
        // params3 : 헤더와 요청파라미터정보 엔터티
        // params4 : 응답데이터를 받을 객체의 타입(ex : dto,map)
        ...
        log.info("토큰 요청 응답데이터 : {}",responseEntity);
